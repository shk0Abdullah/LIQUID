import { Blocks, Network, ArrowLeftRight, Activity } from 'lucide-react'
...
function StatItem({ label, rawValue, prefix = '', sub, icon: Icon, delay }: StatItemProps) {
  return (
...
export function StatsBanner({ latestBlock, nodes, totalTxs }: StatsBannerProps) {
  const difficulty = nodes[0]?.difficulty ?? 0
